$(document).ready(function(){
    		/*$("body").html("<div class='loader'><h3>انتظر..</h3></div>");
*/
 
	

$("header").append("<div class='loader' style='width:50%;height:400px'><h3>انتظر...</h3></div>");
	...
	*/
	...
	$("body").delegate(".category","click",function(event){
		...
		$("#get_product").html("<div class='loader'><h3>انتظر...</h3></div>");
	...
	*/
	...
	$("body").delegate(".selectBrand","click",function(event){
		...
		$("#get_product").html("<div class='loader'><h3>تحميل..</h3></div>");
	...
	$("#search_btn").click(function(){
		...
		$("#get_product").html("<h3>جارى البحث...</h3>");
	...
	*/
	...
	$("body").delegate(".qty","keyup",function(event){
		...
		$('.net_total').html("الاجمالى: $ " +net_total);
	...
	*/
	...
	$("body").delegate(".accordion-menu","click",function(event){
		...
		$("#get_product").html("<h3 class='loader'>.انتظر..</h3>");

		event.preventDefault();

		

		var cid =$(this).attr('lid');
			...
			data	:	{get_seleted_city:1,cat_id:cid},
