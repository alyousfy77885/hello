...
<section class="section">       
	<div class="container-fluid">
			...
			<div class="col-12">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<label for="fname">يتم السداد بواسطه</label>
					...
					<label><input type="CHECKBOX" name="q" class="roomselect" value="conform" required>عنوان الشحن نفس الفواتير
					</label>';
					$i=1;
					$total=0;
				...
				<input type="hidden" name="total_count" value="'.$total_count.'">
					...
					<input type="submit" id="submit" value="استمرار" class="checkout-btn">
				</form>
				</div>
			</div>
			';
		...
		?>
			...
			<div class="col-25">
				<div class="container-checkout" dir="rtl">
				...
				if (isset($_POST["cmd"])) {
					...
					while($i<=$total_count){
						...
						<tr><td><p>$item_number_</p></td><td><p>$item_name_</p></td><td ><p>$quantity_</p></td><td ><p>$amount_</p></td><td><button class='btn btn-primary' onclick='window.print()'>طباعة</button></td></tr>";
				...
				<h3><span class='price' style='color:black;float:left'><b>$total ريال</b></span>اجمالى السعر =</h3>";
