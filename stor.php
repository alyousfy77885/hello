...
(function (global) {
    ...
    global.onload = function () {        
      ...
      <div class="main miain-raised" dir="rtl"> 
		...
		<div class="section">
			...
			<div class="container-fluid">
				...
				<div class="row" >
					<!-- ASIDE -->
					<div id="aside" class="col-md-3" style="float:right">
						<!-- aside Widget -->
						<div id="get_category" style="float:right">
				        </div>
						<!-- /aside Widget -->

						<!-- aside Widget -->
						<div class="aside">
							<h3 class="aside-title" style="text-align:right">الاسعار</h3>
						...
						<!-- aside Widget -->
						<div class="aside">
							<h3 class="aside-title" style="text-align:right">الاكثر طلبا</h3>
					...
					<div id="storeee" class="col-md-9" >
							...
							<div class="store-sort">
								...
								فرز حسب:
									<select class="input-select">
										<option value="0">منتجات جديده</option>
						...
						<!-- store products -->
						<div class="row" id="product-row" style="height:1200px;overflow: auto;">
