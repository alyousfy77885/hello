...
?>
    ...
    global.onload = function () {        
		...
		<!-- SECTION -->
		<div class="section main main-raisedd" dir="">
			<!-- container -->
			<div class="container">
				<!-- row -->
				<div class="row">
...
<div class="row" dir="ltr">
                                ...
                                <div class="col-md-8 col-md-push-12" dir="ltr">
                                <div id="product-imgs" style="">
                                    <div class="product-preview">
                                        <img src="product_images/'.$row['product_image'].'" alt="">
                                    </div>
                    ...
                    <div class="col-md-8 col-md-7" style="text-align:center">
						<div class="product-details">
							...
							<div>
								...
								<a class="review-link" href="#review-form">10 مراجعه(s) | اضافه مراجعه</a>
							</div>
							<div>
						...
						<p>منتج جديد ومضمون 100٪ وارد الهند يتكون من القطن الخالص</p>
							...
							<div class="add-to-cart">
								...
								<button class="add-to-cart-btn" pid="'.$row['product_id'].'"  id="product" ><i class="fa fa-shopping-cart"></i> اضافه للسله</button>
                                </div>
					...
					<div class="col-md-12">
						<div id="product-tab">
							...
							<ul class="tab-nav">
								...
								<li><a data-toggle="tab" href="#tab3">مراجعه (3)</a></li>
							</ul>
							<!-- /product tab nav -->
                        ...
                        echo "
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$pro_price<del class='product-old-price'>$990.0 السعر القديم</del></h4>
										<div class='product-rating'>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
